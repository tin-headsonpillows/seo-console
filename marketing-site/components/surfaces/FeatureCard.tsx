...
export function FeatureCard({ icon, title, description, style }: FeatureCardProps) {
  return (
    ...
    >
      {icon}
      <h3 style={{ margin: 0, fontFamily: "var(--title-md-family)", fontSize: "var(--title-md-size)", fontWeight: "var(--title-md-weight)" as CSSProperties["fontWeight"], color: "var(--text-ink)" }}>
        {title}
      </h3>
