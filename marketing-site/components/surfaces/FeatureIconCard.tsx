...
export function FeatureIconCard({ icon, title, description, style }: FeatureIconCardProps) {
  return (
    <div
      style={{
    ...
    >
      {icon}
      <h4 style={{ margin: 0, fontFamily: "var(--title-sm-family)", fontSize: "var(--title-sm-size)", fontWeight: "var(--title-sm-weight)" as CSSProperties["fontWeight"], color: "var(--text-ink)" }}>
        {title}
      </h4>
